...
public class Solution {
    ...
    /**
     * backtrack helper recursion function that find the place to put the queen at the current row
    ...
    private void backtrackHelper(int n, int row, char[][] board) {
        ...
        if (row == n) {
            ...
            for (char[] rowArray : board) {
                solution.add(new String(rowArray)); // convert the char array to string
            }
            res.add(solution);
            return;
        }
